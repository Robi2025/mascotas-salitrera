...
- Node.js 18+
- Android Studio (incluyendo Android SDK y platform-tools)
...
Importante: para Play Store, la API debe estar en internet (HTTPS).  
`localhost` no funciona en celulares de residentes.
